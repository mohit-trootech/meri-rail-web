          ...
          <div className="flex flex-col items-start justify-center gap-5 w-full">
            {tbis.trains.map((train, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex flex-row items-center justify-between gap-3 w-full border border-gray-700 hover:border-gray-600 shadow-lg hover:shadow-xl duration-300 transition p-3 rounded-xl bg-base-200"
                >
